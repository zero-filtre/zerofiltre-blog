...
module.exports = {
    ...
    'Add article': (browser) => {
        browser
        .fullscreenWindow()
            .waitForElementVisible('button[aria-label="Button to create a new article"]', 5000)
    ...
    'edit article': (browser) => {
        ...
        browser
            .waitForElementVisible("button[aria-label='icon-button with a menu']", 5000)
    ...
    'delete article': (browser) => {
        ...
        browser
            ...
            .waitForElementVisible('button[aria-labelledby="Delete article button"]', 5000)
            .click('button[aria-labelledby="Delete article button"]')
