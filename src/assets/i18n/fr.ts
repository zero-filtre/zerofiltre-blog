export const fr = {
    ...
    meta: {
        ...
        signupDescription: "Rejoignez une communauté d'experts qui changent des vies et des carrières grâce à la tech, et tout ceci sans discrimination et sans filtres.",
